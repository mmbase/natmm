javascript:populateInput('<%= dnumber
      ...
      />','<%= HtmlCleaner.filterEntities(thisParticipant.getStringValue("prefix"))
      %>','<%= HtmlCleaner.filterEntities(thisParticipant.getStringValue("firstname"))
      %>','<mm:field name="initials"
      />','<mm:field name="suffix"
      />','<%= HtmlCleaner.filterEntities(thisParticipant.getStringValue("lastname"))
      %>','<mm:field name="bron"
      ...
      />','<%= HtmlCleaner.filterEntities(thisParticipant.getStringValue("straatnaam"))
      %>','<mm:field name="huisnummer"
      />','<%= HtmlCleaner.filterEntities(thisParticipant.getStringValue("plaatsnaam"))
      %>','<%= HtmlCleaner.filterEntities(thisParticipant.getStringValue("land"))
      ...
      />','<%= HtmlCleaner.filterEntities(sdescription)
