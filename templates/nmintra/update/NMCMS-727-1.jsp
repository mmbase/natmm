...
Volg_nummer;naam;sofinummer_(beaufort);titel_(beaufort);voornaam_(beaufort);initialen_(beaufort);tussenvoegsel_(beaufort);achternaam_(beaufort);geslacht_(beaufort);telefoon_(fz);06-nummer_(fz);fax_(fz);email_(outlook);account_(netwerk);toon_mobiel_(fz);email_automatisch_updaten_(fz);
<mm:listnodes type="medewerkers" orderby="titel" directions="UP"><c:set var="m_volg" value="${m_volg + 1}" /><mm:relatednodes type="images"><c:set 
...
${m_volg};<mm:field name="titel" />;<mm:field name="externid" />;<mm:field name="prefix" />;<mm:field name="firstname" />;<mm:field name="initials" />;<mm:field name="suffix" />;<mm:field name="lastname" />;${gender};<mm:field name="companyphone" />;<mm:field name="cellularphone" />;<mm:field name="fax" />;<mm:field name="email" />;"<mm:field name="account" />";"<mm:field name="titel_zichtbaar" />";</mm:listnodes></mm:cloud></mm:content>
...
voornaam_(beaufort)
initialen_(beaufort)
tussenvoegsel_(beaufort)
achternaam_(beaufort)
geslacht_(beaufort)
telefoon_(fz)
06-nummer_(fz)
fax_(fz)
