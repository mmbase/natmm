...
Volg_nummer;naam;sofinummer_(beaufort);email_(outlook);account_(netwerk);werkzaamheden<mm:listnodes type="medewerkers" orderby="titel" directions="UP"><c:set var="m_volg" value="${m_volg + 1}" /><mm:relatednodes type="images"><c:set 
...
${m_volg};<mm:field name="titel" />;<mm:field name="externid" />;<mm:field name="email" />;"<mm:field name="account" />";"<mm:field name="omschrijving_de" />"</mm:listnodes></mm:cloud></mm:content>
