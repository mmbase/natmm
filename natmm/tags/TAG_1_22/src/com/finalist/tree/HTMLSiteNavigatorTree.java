 ...
 * 
 */
public class HTMLSiteNavigatorTree {
   ...
   public HTMLSiteNavigatorTree() {
      model = null;
   }

   public HTMLSiteNavigatorTree(TreeModel model) {
      this.model = model;
   }

   public HTMLSiteNavigatorTree(TreeModel model, String treeId) {
      this.model = model;
      this.treeId = treeId;
   }
