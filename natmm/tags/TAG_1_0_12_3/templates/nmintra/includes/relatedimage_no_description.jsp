...
%><mm:related path="posrel,images" constraints="posrel.pos='9'" orderby="images.title" searchdir="destination">
...
<mm:related path="posrel,images" orderby="images.title" constraints="posrel.pos!='9'"> 
    ...
    %></mm:field>
     <table border="0" cellpadding="0" cellspacing="0" <%@include file="imagesposition.jsp" %>>
    <%
