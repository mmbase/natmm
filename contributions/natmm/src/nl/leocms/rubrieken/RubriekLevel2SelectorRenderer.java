 ...
 *
 */
public class RubriekLevel2SelectorRenderer extends TreeCellRendererAdapter implements TreeCellRenderer {
   ...
   */
   public void render(Object node, PrintWriter out) {
      ...
      // write the rubrieken
      if ((role.getRol() >= nl.leocms.authorization.Roles.SCHRIJVER) && (level >= 2)) {
         out.println("<span style='width:200px'><a href='javascript:refreshOpenerFrameAndClose(\"" + n.getNumber() + "\")'>" + n.getStringValue("naam") + "</a>");
         out.print("</span>");
      }
      else {
    ...
    */
   public RubriekLevel2SelectorRenderer(RubriekTreeModel model, Map roles, String refreshTarget, String refreshFrame) {
      super();
      this.model = model;
      this.roles = roles;
